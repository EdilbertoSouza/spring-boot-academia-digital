...
<p>Sejam bem-vindos ao meu projeto do desafio: CONHECENDO SPRING DATA JPA NA PRÁTICA COM JAVA.
Desafio este que tive a oportunidade de participar na plataforma de cursos online DIGITAL INNOVATION ONE 💛🧡 e praticar conceitos e conteúdos vistos no: Cloud Fullstack Bootcamp - Warburg Pincus disponibilizado de forma gratuita para a comunidade de desenvolvedores.</p>

<h2>
🛑 Funcionalidades Adicionais
</h2>
<p>Para isso, foi tomado como base o projeto original da instrutora e desenvolvedora Camila e adicionado as seguintes funcionalidades:</p>

<ul>
<li> Criado pacote para organização da captura e retorno das exceções;</li>
<li> Criado classe GlobalExceptionHandler com utilização da anotação: @RestControllerAdvice
para captura centralizada e retorno das principais exceções;</li>
<li> Alterado a assinatura dos métodos de inclusão @PostMapping das classes de Controle.</li>
</ul>
...
<ol>
    ...
    <li> Retorno das Exceções - <em>GlobalExceptionHandler</em></li>
</ol>
